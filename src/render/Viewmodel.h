...
namespace adventure
{
	...
	// weapon (0=sword, 1=dagger, 2=mace) picks the right-hand geometry.
	void drawViewmodel(float bobPhase, float bobAmount, float flickerTime, int meleePhase, float meleeProgress, int swingDir, float charge, float kick, int weapon);
} // namespace adventure

...
void Renderer::postProcess()
{
	...
	DrawTexturePro(m_scene.texture, lowSrc, Rectangle{0, 0, (float)m_lowW, (float)m_lowH}, Vector2{0, 0}, 0.0f, WHITE);
	EndShaderMode();
	EndTextureMode();
}
...
void Renderer::blit()
{
	...
	DrawTexturePro(m_post.texture, lowSrc, Rectangle{0, 0, dstW, dstH}, Vector2{0, 0}, 0.0f, WHITE);
}

...
| M5 | Ranged + spells | Crossbow projectiles, data-driven spell system. | in progress — M5a: crossbow (`combat/Projectile`) reuses the melee charge/release (hold-draw, release-fire); bolts fly/stick to walls/hit enemies, charge scales speed+damage, per-weapon viewmodel. Left: spells (Telekinesis ties to kick/physics), rage-on-ranged |

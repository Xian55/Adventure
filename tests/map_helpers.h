...
// Build a Valve 220 worldspawn with one axis-aligned box brush (map space). Winding-agnostic, so any
// 3 points on each plane work. Shared by the collision/geometry tests.
